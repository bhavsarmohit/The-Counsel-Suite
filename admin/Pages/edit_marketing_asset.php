...
{  
  $get_catdata="SELECT * FROM `marketing_assests` WHERE `c_id`=$reterived_catid";
...
if (isset($_POST['submit'])) {
  ...
  $c_desc = $_POST["desc"];    
  $check_cname="select * from marketing_assests where c_name='$c_name'";
  ...
  {
    $update_sql = "UPDATE marketing_assests SET c_name='$c_name', c_description='$c_desc' WHERE c_id='$c_id'";
  if ($mysqli->query($update_sql) === TRUE) {
    $msg="Asset Details Updated Sucessfully.";
    $showModalSuccessful = "true";
    header("Location: marketing_assets_view.php");
  } else {
    $msg="Failed to update asset details.";
    $showModalFailed = "true";
  }
  }
}
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Modify Marketing Asset</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Modify Marketing Asset</li>
            </ol>
          </div>
            ...
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Update Asset File</h6>
                </div>
                <div class="card-body">
                  <form id="uploadForm" enctype="multipart/form-data">
                  <div class="form-group">
                        <label for="exampleFormControlReadonly">Asset ID</label>
