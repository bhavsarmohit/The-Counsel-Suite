...
{
  $sql = "SELECT * FROM contactus_data";
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">User Queries</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">User Queries</li>
            </ol>
          </div>
                    ...
                    <tbody>
                      ...
                      if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<td>";
                          echo '<a href="edit_legal_contracts.php?id='.$row["userid"].'"><i class="fa fa-pencil"style="color: blue;" aria-hidden="true"></i></a>';
                          echo '<a href="delete_legal_contracts.php?id='.$row["userid"].'"><i class="fa fa-trash-o" style="color: blue; padding-left: 1rem;" aria-hidden="true"></i></a>';
                          echo "</td>";
                          echo "</tr>";
                        }
                      } else {
