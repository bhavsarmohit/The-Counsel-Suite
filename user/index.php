          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <!-- <object class="img-profile rounded-circle" data="profilepic/boy.png" type="image/png" style="max-width: 60px"> -->
                  <img class="img-profile rounded-circle" src="<?php if(file_exists("profilepic/".$u_id)){echo "profilepic/".$u_id;}else{echo "profilepic/boy.png";} ?>" style="max-width: 60px; background-image: url('profilepic/boy.png');">
                <!-- </object> -->
