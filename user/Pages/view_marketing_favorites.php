...
{ 
  $get_favdata="SELECT * FROM favorites WHERE f_userid='$userid' AND parent_catname='marketing'";
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">My Marketing Favorites</h1>
            <ol class="breadcrumb">
                    ...
                    <?php
                      if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<td>";
                          echo '<a href="download_marketing_file1.php?id='.$row["c_id"].'"><i class="fa fa-download"style="color: blue; curosr:pointer;" aria-hidden="true"></i></a>';
                          echo '<a href="remove_fav1.php?id='.$row["f_id"].'"><i class="fa fa-trash" style="color: blue; padding-left: 1rem; curosr:pointer;" aria-hidden="true"></i></a>';
                          echo "</td>";
                          echo "</tr>";
                        }
                      } else {
