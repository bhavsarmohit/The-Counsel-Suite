...
if ($result3->num_rows > 0) {
  ...
  while($row = $result3->fetch_assoc()) {
     $total_download_count=$row["legal_downloads"];
     $total_download_count=$total_download_count+1;
     $update_count="UPDATE users SET legal_downloads='$total_download_count' WHERE u_id='$u_id'";
     $mysqli->query($update_count);
  }
}
//echo $filepath;
...
<script>
  function goback()
  {
    window.location.replace('view_legal_favorites.php');
  }
  </script>
